...
The playlist is shuffled on every page load (random opening track,
random play order).
...
player probes for this file on load and, when present, adds it to the
shuffled playlist — no code change needed.
